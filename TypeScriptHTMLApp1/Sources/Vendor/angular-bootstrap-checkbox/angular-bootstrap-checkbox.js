...
angular.module("ui.checkbox", []).directive("checkbox", function() {
	return {
		...
		restrict: "E",
		replace: "true",
		template: "<button type=\"button\" ng-style=\"stylebtn\" class=\"btn btn-default btn-checkbox\" ng-class=\"{'btn-xs': size==='default', 'btn-sm': size==='large', 'btn-lg': size==='largest', 'checked': checked===true}\">" +
		...
		link: function(scope, elem, attrs, modelCtrl) {
			...
			elem.parent().find('.label').addClass('checkbox-trigger').on('click', function () {
			    elem.trigger('click');
			});
		}
	};
