namespace Directives {
    ...
    export class FormValidation {
        ...
        public compile: (element: ng.IAugmentedJQuery, attrs: ng.IAttributes) => ng.IDirectiveCompileFn;
        public restrict = 'A';

        constructor() {
            var me = this;

            FormValidation.prototype.compile = (element: ng.IAugmentedJQuery, attrs: ng.IAttributes) => {
